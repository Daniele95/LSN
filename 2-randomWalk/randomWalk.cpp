...
void integraleMontecarlo2()
{
   ...
   //tengo salvati nel main solo i vettori costd::ntenenti i dati che poi verranno salvati su file. Gli altri creati e distrutti all'interno della funzione MeanAndErr	
...
void randomWalkDiscreto()
{
   ...
   mat RW(3, NRW, arma::fill::zeros);   //Matrice 3x1e4 posta a zero. Le righe inidicizzano la coordinata (x,y,z), le colonne il RW a passi fissati
   mat Dist_Rad(NSteps,  NRW, arma::fill::zeros); //matrice 1e2x1e4. Le righe indicizzano il passo, le colonne il RW
